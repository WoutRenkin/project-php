            ...
            <div id="page" class="container p-3">
                <div class="card ">
                    <div class="card-header bg-dark text-white">
                        <h3 class="heading has-text-weight-bold is-size-4">Sessie wijzigen</h3>
                    </div>
                    <div class="card-body">
                        <form action="/admin/sessions/{{ $session->id }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select id="organisation_id" name="organisation_id"
                                        ...
                                        oninvalid="this.setCustomValidity('Selecteer een organisatie!')"
                                        oninput="setCustomValidity('')">
                            ...
                            <div class="row justify-content-center align-items-center mb-3">
                                <a class="ml-2 file-upload btn btn-info shadow mr-auto w-50" href="/admin/sessions/{{ $session->id }}/download"><i class="fa fa-download" aria-hidden="true"></i> Download {{$session->file}} </a>
                            </div>
                            <div class="row justify-content-center align-items-center">
                                <label for="fileUpload" id="test"
                                       class="ml-2 file-upload btn btn-primary shadow mr-auto w-50"><i
                            ...
                            <div class="row justify-content-center align-items-center mt-3 mb-3">
                                <div class="progress flex-fill shadow d-none ml-2" id="progresswrap"
                                     style="height: 29px;">
                                    <div id="progress"
